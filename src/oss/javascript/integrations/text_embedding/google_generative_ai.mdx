...
description: "Integrate with the GoogleGenerativeAIEmbeddings embedding model using LangChain JavaScript. Supports multimodal embeddings with Gemini Embedding 2."
---
...
<Note>
**Gemini Embedding 2** (`gemini-embedding-2-preview`) is Google's latest embedding model, built on the Gemini multimodal architecture. It supports 100+ languages, flexible output dimensions (128–3072), and ranks in the top 5 on the MTEB Multilingual leaderboard.
</Note>
...
const embeddings = new GoogleGenerativeAIEmbeddings({
  model: "gemini-embedding-2-preview", // 3072 dimensions (default), supports 128-3072
