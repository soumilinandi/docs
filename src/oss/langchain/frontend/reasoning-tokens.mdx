...
<Info>
Reasoning tokens can be significantly longer than the final answer — sometimes 10x or more. Always default to collapsed view to avoid overwhelming the UI.
</Info>
