...
Agents become truly powerful when they can invoke external tools like weather APIs,
calculators, web search, database queries, and more. But raw JSON tool results
are not what your users want to see. This pattern shows you how to render
