...
<Tip>
If your graph uses [subgraphs](/oss/langgraph/use-subgraphs), you can include subgraph state in the response by passing the `subgraphs` option. See [View subgraph state](/oss/langgraph/use-subgraphs#view-subgraph-state) for details.
</Tip>
...
<Tip>
You can also retrieve the checkpoint history of a subgraph by passing the subgraph's state config to the state history method. See [Get subgraph state history](/oss/langgraph/use-subgraphs#get-subgraph-state-history) for details.
</Tip>
...
<Tip>
You can update subgraph state by passing the subgraph's state config to the update state method. See [Update subgraph state](/oss/langgraph/use-subgraphs#update-subgraph-state) for details.
</Tip>
