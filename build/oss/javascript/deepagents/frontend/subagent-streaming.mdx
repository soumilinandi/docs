...
import { PatternEmbed } from "/build/snippets/pattern-embed.jsx"

<PatternEmbed pattern="deep-agent-subagent-cards" />

## How it differs from basic subagent streaming

The basic [subagent streaming](/oss/javascript/deepagents/frontend/subagent-streaming) pattern exposes a
